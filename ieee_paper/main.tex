...
\title{A Rolling-Origin Forecasting and Monitoring Framework\\ for Official Reported-Crime Trends in Bangladesh}

\author{
\IEEEauthorblockN{Ifaz Ahmed Chowdhury, Jubair Ahmed, Md.\ Sakib Abdullah, and Md.\ Imran Hasan Shanto}
...
numbers that PHQ released later. For national Total Cases the forecast was 98.9\% accurate at 1
month, 97.8\% at 3 months, 92.8\% at 6 months, and 86.1\% at 12 months. The ensemble was the most reliable model.
...
we look further ahead, exactly what we expect from an honest forecast. This same checking step
...
The verified dataset, the analysis notebook with all results and figures, and the monitoring
application are provided as a companion package, so every number and figure in this paper can be
regenerated.
